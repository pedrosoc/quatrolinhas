...
export default styled(Container)`
    ...
    margin: 0 auto;
    padding: ${props => props.tight ? 0 : styles.container_margin_medium} ${styles.container_margin_small};

    @media only screen and (min-width: ${styles.breakpoint_medium}) {
        width: ${styles.container_medium};
        margin: 0 auto;
        padding: ${props => props.tight ? 0 : styles.container_margin_large} ${styles.container_margin_small};
    }
